...
//Note: you will need to setup proper IAM and Jenkins access credentials to run this command.
          ...
          withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', accessKeyVariable: 'AWS_ACCESS_KEY_ID', credentialsId: 'AWA Credential', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY']]) {
